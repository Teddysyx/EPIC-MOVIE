...
const featuredMovies = [
    ...
    },
    {
        ...
        fallbackLogo: "https://pixeldrain.com/api/file/pMNZ7xTz",
...
// HLAVNÍ OPRAVA: Skryjeme hero sekci hned na začátku
document.addEventListener('DOMContentLoaded', function() {
    // Okamžitě skryjeme hero sekci, než se načte náhodný film
    ...
    // Načteme náhodný film a playlist
    setRandomHeroMovie();
    loadPlaylist();
});
...
function setRandomHeroMovie() {
    ...
    // Hero sekce je už skrytá z DOMContentLoaded, takže jen nastavíme loading
    ...
    setTimeout(() => {
        ...
        bgImage.onload = function() {
            ...
            // Až se načte pozadí, zobrazíme celou hero sekci
            heroContent.innerHTML = `
