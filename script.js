...
function parseM3U(m3uText) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (line.startsWith('#EXTINF:')) {
            ...
            const logo = logoMatch ? logoMatch[1] : 'https://via.placeholder.com/300x450/333333/666666?text=EPIC+MOVIE';
    ...
    channels.forEach(channel => {
        ...
        movieElement.innerHTML = `
            <img src="${channel.logo}" alt="${channel.name}" class="movie-poster" 
                 onerror="this.src='https://via.placeholder.com/300x450/333333/666666?text=EPIC+MOVIE'">
        `;
